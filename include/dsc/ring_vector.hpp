...
class ring_vector {
 ...
 public:
    ...
    explicit ring_vector(ui32 reserve_space):  m_begin(0), m_end(0), m_size(0) {
        m_capacity_bits = 2;
    ...
    class iterator {
     ...
     public:
        ...
        explicit iterator(ring_vector<T>& array, ui32 idx = 0) : m_array(array), m_idx(idx) {}
    ...
    class const_iterator {
     ...
     public:
        ...
        explicit const_iterator(const ring_vector<T>& array, ui32 idx = 0) : m_array(array), m_idx(idx) {}
